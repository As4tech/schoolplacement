...
$uid=$_GET['id'];
$getuid=decript($uid);
$user=mysqli_query($conn,"select * from houses where id='$getuid'");
                                ...
                                <div class="x_content">
                                    <form class="" action="" method="post" novalidate>
                                      <?php 
										...
										$hsename=mysqli_real_escape_string($conn,$_POST['hsename']);
										$tdate=mysqli_real_escape_string($conn,$_POST['tdate']);
										$users=mysqli_query($conn,"SELECT * FROM houses WHERE id='$getuid'")or die(mysqli_error($conn));
										$countusers=mysqli_num_rows($users);
										if($countusers==1)
										{
										$userupdate=mysqli_query($conn,"update houses set schlname='$schlname',hsename='$hsename',tdate='$tdate' where id='$getuid'");
										if($userupdate)
										{
											echo
											"
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<option><?php echo $userarray['schlname'] ?></option>
												<?php
												require("connect.php");
										...
										<div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" value="<?php echo $userarray['hsename'] ?>" data-validate-length-range="" data-validate-words="" name="hsename" placeholder="Enter Full Name" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <a href="hseview.php" type='reset' class="btn btn-primary">Back</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
