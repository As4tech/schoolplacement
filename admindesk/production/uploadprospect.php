        ...
        <div class="">
          ...
          <div class="row">
            ...
            require("connect.php");
						...
						$pdf_store="prospect/".$pdf;
						move_uploaded_file($pdf_tem_loc,$pdf_store);
						$tdate=mysqli_real_escape_string($conn,$_POST['tdate']);
						
						$admisdoc=mysqli_query($conn,"SELECT * FROM prospectus where schoolname='$schlname'")or die(mysqli_error($conn));
						$cadmisdoc=mysqli_num_rows($admisdoc);
						if($cadmisdoc==1)
						{
							echo
								"
								<button class='btn btn-danger' style='font-weight:bold;pointer-events:none;display:block;margin:auto;width:100%;min-width:100%;max-width:50%;position:rlative'>Prospectus for $schlname Already Exist.</button>
								";	
						}else
						{
							$insertletter=mysqli_query($conn,"INSERT INTO prospectus(schoolname,prospectus,tdate)
							VALUES('$schlname','$pdf','$tdate')")or die(mysqli_error($conn));
							if($insertletter)
							{
								echo
								"
								<button class='btn btn-success' style='font-weight:bold;pointer-events:none;display:block;margin:auto;width:100%;min-width:100%;max-width:50%;position:rlative'>Prospectus for $schlname Successfully Uploaded.</button>
								";	
							}
						}
					}
				  ...
				  <span class="section">Upload Prospectus</span>
                    ...
                    <a href='prospectview.php' class="btn btn-primary">View</a>
