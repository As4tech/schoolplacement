      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row" style="display: inline-block;">
            ...
            $date=date('Y-m-d');
            require("connect.php");
            $enrol=mysqli_query($conn,"select * from students ");
            $cenrol=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where gender='Male' && tdate='$date'");
            $tmenrol=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where  gender='Female' && tdate='$date'");
            $tfenrol=mysqli_num_rows($enrol);


            $enrol=mysqli_query($conn,"select * from students where  tdate='$date'");
            $tenrol=mysqli_num_rows($enrol);


            $enrol=mysqli_query($conn,"select * from students where admrdate='$date' and admstatus='1' ");
            $tcadm=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where admstatus='1' and gender='Male' AND admrdate='$date' ");
            $tmadm=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where admstatus='1' and gender='Female' AND admrdate='$date' ");
            ...
            $enrol=mysqli_query($conn,"select * from students where  gender='Male'");
            $menrol=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where gender='Female'");
            $fenrol=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where admstatus='1'");
            $admstud=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where admstatus='1' and gender='Male'");
            $madmision=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where admstatus='1' and gender='Female'");
            $fadmision=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where admstatus='1' and sstatus='Boarding'");
            $badmision=mysqli_num_rows($enrol);

            $enrol=mysqli_query($conn,"select * from students where admstatus='1' and sstatus='Day'");
            ...
            ?>
              ...
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats">
                  <div class="icon"><i class="fa fa-home" style="color:green"></i></div>
