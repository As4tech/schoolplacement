...
$uid=$_GET['id'];
$getuid=decript($uid);
$user=mysqli_query($conn,"select * from users where id='$getuid'");
                                ...
                                <div class="x_content">
                                    <form class="" action="" method="post" novalidate>
                                      <?php 
										...
										$users=mysqli_query($conn,"SELECT * FROM users WHERE id='$getuid'")or die(mysqli_error($conn));
										$countusers=mysqli_num_rows($users);
										if($countusers==1)
										{
										$userupdate=mysqli_query($conn,"update users set schoolname='$schlname',schoolcode='$schlcode',fullname='$fname',phone='$telephone',username='$username',ulevel='$accesslevel' where id='$getuid'");
										if($userupdate)
										{
											echo
											"
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<option><?php echo $userarray['schoolname'] ?></option>
												<?php
												require("connect.php");
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" value="<?php echo $userarray['schoolcode'] ?>" data-validate-length-range="" data-validate-words="" name="schlcode" placeholder="Enter Full Name" required="required" />
                                            </div>
                                        </div>
										<div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Full Name<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" value="<?php echo $userarray['fullname'] ?>" data-validate-length-range="" data-validate-words="" name="fname" placeholder="Enter Full Name" required="required" />
                                            </div>
                                        </div>
                                         ...
                                         <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="tel" value="<?php echo $userarray['phone'] ?>" class='tel' name="phone" required='required' data-validate-length-range="8,20" /></div>
                                        </div>
										<div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">User Name<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control"  name="uname" value="<?php echo $userarray['username'] ?>" placeholder="Enter User Name" required="required" />
                                            </div>
                                        </div>
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<option><?php echo $userarray['schoolcode'] ?></option>
												<?php
												require("connect.php");
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <a href="vusers.php" type='reset' class="btn btn-primary">Back</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
